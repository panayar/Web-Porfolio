...
function SkillsBanner() {
  ...
  return (
    <div className="row" style={{ marginTop: "12%" }}>
      <div className="d-lg-block d-md-none d-sm-none col-sm-12 col-lg-6 col-md-12 p-4 text-sm-justify off text-center">
        <div className="center" style={{marginTop: "200px"}}>
          <Carrousel />
        </div>
      </div>
      <div className="col-sm-12 col-lg-6 col-md-12 p-4 text-sm-justify ">
        <h1 className="text-center" data-aos="fade-up" data-aos-duration="1800">
          Skills
        ...
        >
          ...
          <strong> HTML, CSS, JavaScript, TypeScript, React, Angular</strong> ,
          and various CSS frameworks. Additionally, I have experience working
          with backend technologies like
          <strong> Node.js, Express.js, and MongoDB.</strong> I have a
          comprehensive understanding of software development methodologies and
          have worked with Agile methodologies such as{" "}
          ...
          with my ability to learn quickly, allows me to take on new challenges
          and continuously improve my skills. Overall, my skills, experience,
          and commitment to excellence make me a valuable asset to any
          development team.
        </p>
      </div>
      <div className="col-sm-12 col-lg-6 col-md-12 d-lg-none d-md-block p-4 center">
        <Carrousel />
      </div>
    </div>
  );
